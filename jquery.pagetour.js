    ...
    PageTour = (function() {
      ...
      */
      ...
      PageTour.prototype._setMask = function(position, size) {
        ...
        if (this.options.showMasks) {
          ...
          this.masks.left.css({
            height: size.y + ((this.currentStepElement.padding || 0) * 2),
            top: position.y - (this.currentStepElement.padding || 0),
            width: position.x - (this.currentStepElement.padding || 0)
          }).fadeTo(100, o.fadeTo);
          this.masks.right.css({
            height: size.y + ((this.currentStepElement.padding || 0) * 2),
            top: position.y - (this.currentStepElement.padding || 0),
            width: $(document.body).width() - position.x - size.x - (this.currentStepElement.padding || 0)
          }).fadeTo(100, o.fadeTo);
        }
      ...
      */
      ...
      PageTour.prototype._doStep = function() {
        var currStep, marginBottom, marginTop, originalPosition, position, scrollTopOffset, size, _tmp_last_element, _tmp_last_step;
      ...
      */
      ...
      PageTour.prototype.start = function() {
        if (!this.started) {
          $(document.body).trigger("" + this.options.prefix + "Started");
          this._setDocumentHeight();
          this.started = true;
      ...
      PageTour.prototype.close = function() {
        ...
        this.masks.wrapper.stop().fadeTo(500, 0, function() {
          ...
          return $(document.body).trigger("" + _this.options.prefix + "Closed");
        });
        return this;
      };
